...
class GameScene(Scene):
    def setup(self):
        ...
        resume_button_position.x = 384
        resume_button_position.y = 412
        self.resume_button = SpriteNode('./assets/sprites/resume.PNG',
                                       parent = self,
        ...
        # game over label
        game_over_label_position = self.size
        game_over_label_position.x = 384
        game_over_label_position.y = 400
    ...
    def touch_began(self, touch):
        ...
        if self.pause_button.frame.contains_point(touch.location):
            self.pause_button.scale = 0.065

        # resume button
        if self.resume_button.frame.contains_point(touch.location):
            self.resume_button.scale = 0.45
